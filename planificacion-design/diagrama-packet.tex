...
\graphicspath{{../images/}}
	...
	\begin{figure}[h!]
		...
		\begin{subfigure}[b]{0.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{C:/Users/dmata/Downloads/cisco-diagram-piso1}
			\caption{Piso 1}
			\label{fig:piso1}
		\end{subfigure}
		\hfill 
		\begin{subfigure}[b]{0.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{C:/Users/dmata/Downloads/cisco-diagram-piso2}
			\caption{Piso 2}
			\label{fig:piso2}
		\end{subfigure}
		\hfill 
		\begin{subfigure}[b]{0.3\textwidth}
			\centering
			\includegraphics[width=\linewidth]{C:/Users/dmata/Downloads/cisco-diagram-piso3}
			\caption{Piso 3}
			\label{fig:piso3}
		\end{subfigure}
	...
	\begin{figure}[h!]
		...
		\includegraphics[width=0.3\textwidth]{C:/Users/dmata/Downloads/cisco-diagram-conexion-innovacion}
