...
Los elementos principales incluyen el cableado estructurado, conectores, paneles de parcheo y la infraestructura de soporte. El cableado horizontal se compone de cable UTP categoría 6, encargado de enlazar los nodos con los armarios de comunicaciones, mientras que el backbone recurre a fibra óptica multimodo OM3 para enlaces de alta capacidad \parencite{systimax2020structured}. La organización se completa con \textit{patch panels}, racks y accesorios para mantener el orden del tendido \parencite{flukenetworks2022cablemanagement}.
